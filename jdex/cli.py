...
class CLI:
    ...
    def logo(
        self,
        tool_name: str = "JDEX",
        suite_name: str = "JediKG Dataset Generation Suite",
        lab: str = "ARA@T3 Laboratory, University of Bari Aldo Moro",
    ...
    def panel(self, title: str = "None", data: list[tuple[str, int]] | None = None):
        data = data or []
    ...
    def input(self, message: str, default: str) -> any:

        return Prompt.ask(message, default=default)

    def list(self, title: str = "None", data: list[str] | None = None):
        data = data or []
    ...
    def rule(self, title: str = ""):
        self._print_fixed(Rule(title, style="green", align="center"))

    def subrule(self, title: str = ""):
        self._print_fixed(Rule(title, style="dim yellow", align="center"))
