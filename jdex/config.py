...
class MaterializationConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if self.reasoner not in allowed_reasoners:
            raise ValueError(
                f"Unsupported reasoner {self.reasoner}"
            )
...
class RealizationConfig:
    ...
    def from_dict(cls, data: dict[str, Any] | None) -> "RealizationConfig":
        data = data or {}
        return cls(enabled=data.get("enabled", True), reasoner=data.get("reasoner", "konclude"))
...
class SatisfiabilityConfig:
    ...
    def from_dict(cls, data: dict[str, Any] | None) -> "SatisfiabilityConfig":
        data = data or {}
        return cls(filter_unsatisfiable=data.get("filter_unsatisfiable", False), reasoner=data.get("reasoner", "hermit"))
